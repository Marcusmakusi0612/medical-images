...
logdir = f"/media/yfl508/My Passport/seg/segmamba-yaozhui/logs/segmamba-plain"
...
class SegTrainer(Trainer):
    def __init__(self, env_type, max_epochs, batch_size, device="cpu", val_every=1, num_gpus=1, logdir="./logs/", master_ip='localhost', master_port=17750, training_script="train.py"):
        ...
        from model_segmamba.segmamba_DWCGLA import SegMamba
    ...
    def validation_end(self, val_outputs):
        ...
        zhuijianpan, gaihua = dices[0].mean(), dices[1].mean()

        print(f"dices is {zhuijianpan, gaihua}")

        mean_dice =  zhuijianpan
        
        self.log("zhuijianpan", zhuijianpan, step=self.epoch)
        self.log("gaihua", gaihua, step=self.epoch)
